...
class bitmex extends ccxt.pro.bitmex {
    ...
    parseTicker(ticker, market = undefined) {
        ...
        return this.safeTicker({
            ...
            'average': undefined,
            'baseVolume': this.numberToString(this.convertFromRawQuantity(symbol, this.safeString(ticker, 'homeNotional24h'))),// LFERN numberToString added
            'quoteVolume': this.numberToString(this.convertFromRawQuantity(symbol, this.safeString(ticker, 'foreignNotional24h'))),// LFERN numberToString added
            'info': ticker,
        }, market);
    }
